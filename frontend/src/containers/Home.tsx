...
export const Home = () => {
  ...
  if(!auth.isAuthenticated)
  {
    return (
      <div>
        <br />
        <h1 className='font-source-code-pro'>Welcome to GITGUESSR</h1>
        <br />
        <br />
          ...
          <div className='row'>
            <div className='col'>
              <div className='inner-container'>
                ...
                <div className='row'>
                  <div className='column'>
                    <Button className='mb-3 btn-lg' variant='light' onClick={() => navigate('/party')}>Party</Button>
                  </div>
                  <div className='column'></div>
                </div>
                <div className='row'>
                  <div className='column'>
                    <Button className='mb-3 btn-lg' variant='light' onClick={() => navigate('/quiz')}>Quiz</Button>
                  </div>
                  <div className='column'></div>
                </div>
                <div className='row'>
                  <div className='column'>
                    <Button className='mb-3 btn-lg' variant='light' onClick={() => navigate('/daily-challenge')}>Daily Challenge</Button>
                  </div>
                  <div className='column'></div>
                </div>
              </div>
